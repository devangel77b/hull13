...
int main(void){
  ...
  pc.printf("\n\rGPS parsing test\n\r");
  pc.printf("Test if parser correctly parses a GPRMC message with junk postfix\n\r");
  

  // test a GPRMC message
  pc.printf("$GPRMC,201547.000,A,3014.5527,N,09749.5808,W,0.24,163.05,040109,,*1A\n\r SMEG");
  sendstring("$GPRMC,201547.000,A,3014.5527,N,09749.5808,W,0.24,163.05,040109,,*1A\n SMEG");
